...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , R, R(dest) = (word_t)(src1 >> (word_t)BITS(src2, 5, 0)));
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, vaddr_t ex_pc = isa_raise_intr(11,s->pc); s->dnpc = ex_pc; );//printf("jump to %lx \n",ex_pc)
