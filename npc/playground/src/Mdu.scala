...
//total 32 csas
  ...
  //level 2
  csa(11).io.x := s_l1(0) ; csa(11).io.y := c_l1(0) ; csa(11).io.z := c_l1(1) ;
  csa(12).io.x := s_l1(1) ; csa(12).io.y := c_l1(2) ; csa(12).io.z := s_l1(2) ;
  csa(13).io.x := s_l1(3) ; csa(13).io.y := c_l1(3) ; csa(13).io.z := c_l1(4) ;
  csa(14).io.x := s_l1(4) ; csa(14).io.y := c_l1(5) ; csa(14).io.z := s_l1(5) ;
  csa(15).io.x := s_l1(6) ; csa(15).io.y := c_l1(6) ; csa(15).io.z := c_l1(7) ;
  csa(16).io.x := s_l1(7) ; csa(16).io.y := c_l1(8) ; csa(16).io.z := s_l1(8) ;
  csa(17).io.x := s_l1(9) ; csa(17).io.y := c_l1(9) ; csa(17).io.z := pp33;

  s_l2(0) := csa(11).io.s ; c_l2(0) := csa(11).io.c
  s_l2(1) := csa(12).io.s ; c_l2(1) := csa(12).io.c
  s_l2(2) := csa(13).io.s ; c_l2(2) := csa(13).io.c
  s_l2(3) := csa(14).io.s ; c_l2(3) := csa(14).io.c
  s_l2(4) := csa(15).io.s ; c_l2(4) := csa(15).io.c
  s_l2(5) := csa(16).io.s ; c_l2(5) := csa(16).io.c
  s_l2(6) := csa(17).io.s ; c_l2(6) := csa(17).io.c

  //level 3
  csa(18).io.x := s_l1(10) ; csa(18).io.y := c_l1(10) ; csa(18).io.z := s_l2(0);
  csa(19).io.x := c_l2(0) ; csa(19).io.y := s_l2( 1); csa(19).io.z := c_l2(1);
  csa(20).io.x := s_l2( 2); csa(20).io.y := c_l2( 2); csa(20).io.z := s_l2(3);
  csa(21).io.x := c_l2( 3); csa(21).io.y := s_l2( 4); csa(21).io.z := c_l2(4);
  csa(22).io.x := s_l2( 5); csa(22).io.y := c_l2( 5); csa(22).io.z := s_l2(6);

  s_l3(0) := csa(18).s ; c_l3(0) := csa(18).c ;
  s_l3(1) := csa(19).s ; c_l3(1) := csa(19).c ;
  s_l3(2) := csa(20).s ; c_l3(2) := csa(20).c ;
  s_l3(3) := csa(21).s ; c_l3(3) := csa(21).c ;
  s_l3(4) := csa(22).s ; c_l3(4) := csa(22).c ;

  //level 4
  csa(23).io.x := c_l2(6) ; csa(23).io.y := s_l3(0) ; csa(23).io.z := c_l3(0);
  csa(24).io.x := s_l3(1) ; csa(24).io.y := c_l3(1) ; csa(24).io.z := s_l3(2);
  csa(25).io.x := c_l3(2) ; csa(25).io.y := s_l3(3) ; csa(25).io.z := s_l3(3);

  s_l4(0) := csa(23).s ; c_l4(0) := csa(23).c ;
  s_l4(1) := csa(24).s ; c_l4(1) := csa(24).c ;
  s_l4(2) := csa(25).s ; c_l4(2) := csa(25).c ;

  //register these 8 values in pp_l2

  //level 5
  csa(26).io.x := pp_l2(0) ; csa(26).io.y := pp_l2(1) ; csa(26).io.z := pp_l2(2);
  csa(27).io.x := pp_l2(3) ; csa(27).io.y := pp_l2(4) ; csa(27).io.z := pp_l2(5);

  s_l5(0) := csa(26).s ; c_l5(0) := csa(26).c ;
  s_l5(1) := csa(27).s ; c_l5(1) := csa(27).c ;

  //level 6
  csa(28).io.x := pp_l2(6) ; csa(28).io.y := pp_l2(7) ; csa(28).io.z := s_l5(0);
  csa(29).io.x := s_l5(1)  ; csa(29).io.y := c_l5(0)  ; csa(29).io.z := c_l5(0);

  s_l6(0) := csa(28).s ; c_l6(0) := csa(28).c ;
  s_l6(1) := csa(29).s ; c_l6(1) := csa(29).c ;

  //level 7
  csa(30).io.x := s_l6(0) ; csa(30).io.y := s_l6(1) ; csa(30).io.z := c_l6(0);

  s_l7 := csa(30).s ; c_l7 := csa(30).c ;

  //level 8
  csa(31).io.x := s_l7 ; csa(31).io.y := c_l7 ; csa(31).io.z := c_l6(1);

  s_l8 := csa(31).s ; c_l8 := csa(31).c ;
  temp_out := s_l8 + c_l8
