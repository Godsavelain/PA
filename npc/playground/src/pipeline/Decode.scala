...
class Decode extends Module{
  ...
  val ctrl = ListLookup(inst,
    ...
    Array(
      ...
      LB      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_LD,  MEM_BYTE,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_I    ),
      LH      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_LD,  MEM_HALF,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_I    ),
      LW      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_LD,  MEM_WORD,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_I    ),
      LBU     ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_LDU, MEM_BYTE,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_I    ),
      LHU     ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_LDU, MEM_HALF,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_I    ),
      SB      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_BYTE,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM,  N, IMM_S    ),
      SH      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_HALF,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM,  N, IMM_S    ),
      SW      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_WORD,  CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM,  N, IMM_S    ),
      ...
      SD      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_DWORD, CSR_X,     N, RS_FROM_RF,   RS_FROM_IMM,  N, IMM_S    ),
