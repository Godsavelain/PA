...
class Decode extends Module{
  ...
  val ctrl = ListLookup(inst,
    ...
    Array(
      ...
      //MDU
      MUL     ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_MUL   ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X ),
      MULH    ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_MULH  ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X ),
      MULHSU  ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_MULHSU,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X   ),
      MULHU   ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_MULHU ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X   ),
      DIV     ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_DIV   ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X   ),
      DIVU    ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_DIVU  ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X   ),
      REM     ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_REM   ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X   ),
      REMU    ->  List(Y, FU_ALU, ALU_X,  JMP_X,    MEM_X,   MEM_X,     CSR_X, MDU_REMU  ,     N, RS_FROM_RF,   RS_FROM_RF,  Y, IMM_X   ),
