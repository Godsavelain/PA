...
class Decode extends Module{
  ...
  val ctrl = ListLookup(inst,
    ...
    Array(
      ...
      SB      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_BYTE,  CSR_X,     N, RS_FROM_RF,   RS_FROM_RF,  N, IMM_S    ),
      SH      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_HALF,  CSR_X,     N, RS_FROM_RF,   RS_FROM_RF,  N, IMM_S    ),
      SW      ->  List(Y, FU_MEM, ALU_ADD,    JMP_X,    MEM_ST,  MEM_WORD,  CSR_X,     N, RS_FROM_RF,   RS_FROM_RF,  N, IMM_S    ),
