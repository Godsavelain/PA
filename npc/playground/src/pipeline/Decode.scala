...
class Decode extends Module{
  ...
  val ctrl = ListLookup(inst,
    ...
    Array(
      ...
      SLLI    ->  List(Y, FU_ALU, ALU_SLL,  JMP_X,    MEM_X,   MEM_X,     CSR_X,  MDU_X,    N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_SHAM ),
      SRLI    ->  List(Y, FU_ALU, ALU_SRL,  JMP_X,    MEM_X,   MEM_X,     CSR_X,  MDU_X,    N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_SHAM ),
      SRAI    ->  List(Y, FU_ALU, ALU_SRA,  JMP_X,    MEM_X,   MEM_X,     CSR_X,  MDU_X,    N, RS_FROM_RF,   RS_FROM_IMM, Y, IMM_SHAM ),
