...
void VCore___024root__traceFullSub0(VCore___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+1388,((1U & ((~ (IData)(vlSelf->Core__DOT__fetch__DOT__stall)) 
        ...
        tracep->fullIData(oldp+1527,(((IData)(vlSelf->Core__DOT__fetch__DOT___io_out_bits_pc_T_1)
        ...
        tracep->fullBit(oldp+1528,(((~ ((IData)(vlSelf->Core__DOT__fetch__DOT___io_out_bits_pc_T_1) 
                                        | (IData)(vlSelf->Core__DOT__fetch__DOT__first_instr))) 
                                    & ((IData)(vlSelf->Core__DOT__fetch__DOT__use_reg_info)
                                        ? (IData)(vlSelf->Core__DOT__fetch__DOT__valid_out)
                                        : (IData)(vlSelf->io_imem_resp_bits_read_ok)))));
        tracep->fullBit(oldp+1529,((1U & (~ (IData)(vlSelf->io_imem_resp_bits_read_ok)))));
