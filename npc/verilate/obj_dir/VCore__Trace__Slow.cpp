...
void VCore___024root__traceInitSub0(VCore___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+125,"Core io_dmem_raddr_hi", false,-1, 28,0);
        ...
        tracep->declBus(c+186,"Core mem mem_reg_decodeop_rd_addr", false,-1, 4,0);
...
void VCore___024root__traceFullSub0(VCore___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+186,(vlSelf->Core__DOT__mem__DOT__mem_reg_decodeop_rd_addr),5);
